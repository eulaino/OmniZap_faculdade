...
export function PromoCard({ promo }: PromoCardProps) {
  return (
    <Pressable
      ...
      <View
        className="relative h-36 items-center justify-center"
        ...
        {promo.tag && (
          <View className="absolute left-3 top-3 flex-row gap-x-1 rounded-lg bg-orange-600 px-2.5 py-1">
            <Zap size={9} color="#f59e0b" fill="#f59e0b" />
            <Text
              className="font-semibold text-white"
              style={{ fontSize: 9, fontFamily: 'Inter_700Bold' }}>
              {promo.tag}
            </Text>
          </View>
        )}
      ...
      <View className="gap-y-1 px-3.5 py-3">
        ...
        <View className="flex-row items-center gap-x-1">
          ...
          <Text className="text-sm text-gray-700" style={{ fontFamily: 'Inter_700Bold' }}>
            4.8
          </Text>
